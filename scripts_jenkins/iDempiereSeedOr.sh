...
TODAY=`date +%Y%m%d`
echo "update ad_system set lastmigrationscriptapplied = '${TODAY}_DailyBuild' || $BUILD_NUMBER || '/' || lastmigrationscriptapplied;" | sqlplus $ADEMPIERE_DB_USER/$ADEMPIERE_DB_PASSWORD@$HOST/$DATABASE
