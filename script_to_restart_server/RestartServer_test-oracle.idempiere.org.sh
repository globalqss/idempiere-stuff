...
then
    ...
    # required to work with docker
    # cd /opt/idempiere/idempiere-server/data/seed || exit 1
    # jar xvf Adempiere.jar
    # sudo chgrp ubuntu /opt/idempiere/idempiere-server/data
    # sudo chgrp ubuntu /opt/idempiere/idempiere-server/data/seed
    # sudo chgrp ubuntu /opt/idempiere/idempiere-server/data/seed/Adempiere.dmp
fi
