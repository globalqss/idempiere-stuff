...
# June 27, 2013
# Script to synchronize your 3.1 installation with latest migration scripts
# it's a tool to execute in sync with the p2 update
#   sh update.sh http://ci.idempiere.org/job/iDempiere3.1/ws/buckminster.output/org.adempiere.server_3.1.0-eclipse.feature/site.p2
#
DATABASE=idempiere
USER=adempiere
